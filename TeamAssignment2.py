            ...
            if userIDlogin in database and passwordlogin != database[userIDlogin]["Password"] and coba < batascoba:
              ...
              time.sleep(10)
                ...
                while opsimainmenu != "16":
                    ...
                    print("13. Currency Converter")
                    print("14. Ganti Password")
                    print("15. Hapus Akun")
                    print("16. Log Out")
                    ...
                    ### CURRENCY CONVERTER
                        ...
                        print("Currency Converter Support On: ")
                        print("")
                        print("1.  Albania      Lek         (ALL)" )
                        print("2.  Afghanistan  Afghani     (AFN)" )
                        print("3.  Argentina    Peso        (ARS)" )
                        print("4.  Australia    Dollar      (AUD)" )
                        print("5.  Azerbaijan   Manat       (AZN)" )
                        print("6.  Bahamas      Dollar      (BSD)" )
                        print("7.  Barbados     Dollar      (BBD)" )
                        print("8.  Belarus      Ruble       (BYN)" )
                        print("9.  Belize       Dollar      (BZD)" )
                        print("10. Bermuda      Dollar      (BMD)" )
                        print("11. Bolivia      Bolíviano   (BOB)" )
                        print("12. Bosnia       Mark        (BAM)" )
                        print("13. Botswana     Pula        (BWP)" )
                        print("14. Bulgaria     Lev         (BGN)" )
                        print("15. Brazil       Real        (BRL)" )
                        print("16. Brunei       Dollar      (BND)" )
                        print("17. Cambodia     Riel        (KHR)" )
                        print("18. Canada       Dollar      (CAD)" )
                        print("19. Cayman I.    Dollar      (KYD)" )
                        print("20. Chile        Peso        (CLP)" )
                        print("21. China        Yuan        (CNY)" )
                        print("22. Colombia     Peso        (COP)" )
                        print("23. Costa Rica   Colon       (CRC)" )
                        print("24. Croatia      Kuna        (HRK)" )
                        print("25. Cuba         Peso        (CUP)" )
                        print("26. Czech Rep.   Koruna      (CZK)" )
                        print("27. Denmark      Krone       (DKK)" )
                        print("28. Dominican R. Peso        (DOP)" )
                        print("29. E.Caribbean  Dollar      (XCD)" )
                        print("30. Egypt        Pound       (EGP)" )
                        print("31. El Salvador  Colon       (SVC)" )
                        print("32. Europe       Euro        (EUR)" )
                        print("33. Falkland I.  Pound       (FKP)" )
                        print("34. Fiji         Dollar      (FJD)" )
                        print("35. Ghana        Cedi        (GHS)" )
                        print("36. Gibraltar    Pound       (GIP)" )
                        print("37. Guatemala    Quetzal     (GTQ)" )
                        print("38. Guernsey     Pound       (GGP)" )
                        print("39. Guyana       Dollar      (GYD)" )
                        print("40. Honduras     Lempira     (HNL)" )
                        print("41. Hong Kong    Dollar      (HKD)" )
                        print("42. Hungary      Forint      (HUF)" )
                        print("43. Iceland      Krona       (ISK)" )
                        print("44. India        Rupee       (INR)" )
                        print("45. Indonesia    Rupiah      (IDR)" )
                        print("46. Iran         Rial        (IRR)" )
                        print("47. Isle of Man  Pound       (IMP)" )
                        print("48. Israel       Shekel      (ILS)" )
                        print("49. Jamaica      Dollar      (JMD)" )
                        print("50. Japan        Yen         (JPY)" )
                        print("51. Jersey       Pound       (JEP)" )
                        print("52. Kazakhstan   Tenge       (KZT)" )
                        print("53. Korea(North) Won         (KPW)" )
                        print("54. Korea(South) Won         (KRW)" )
                        print("55. Kyrgyzstan   Som         (KGS)" )
                        print("56. Laos         Kip         (LAK)" )
                        print("57. Lebanon      Pound       (LBP)" )
                        print("58. Liberia      Dollar      (LRD)" )
                        print("59. Macedonia    Denar       (MKD)" )
                        print("60. Malaysia     Ringgit     (MYR)" )
                        print("61. Mauritius    Rupee       (MUR)" )
                        print("62. Mexico       Peso        (MXN)" )
                        print("63. Mongolia     Tughrik     (MNT)" )
                        print("64. Mozambique   Metical     (MZN)" )
                        print("65. Namibia      Dollar      (NAD)" )
                        print("66. Nepal        Rupee       (NPR)" )
                        print("67. Netherlands  Guilder     (ANG)" )
                        print("68. New Zealand  Dollar      (NZD)" )
                        print("69. Nicaragua    Cordoba     (NIO)" )
                        print("70. Nigeria      Naira       (NGN)" )
                        print("71. Norway       Krone       (NOK)" )
                        print("72. Oman         Rial        (OMR)" )
                        print("73. Pakistan     Rupee       (PKR)" )
                        print("74. Panama       Balboa      (PAB)" )
                        print("75. Paraguay     Guarani     (PYG)" )
                        print("76. Peru         Sol         (PEN)" )
                        print("77. Philippines  Peso        (PHP)" )
                        print("78. Poland       Zloty       (PLN)" )
                        print("79. Qatar        Riyal       (QAR)" )
                        print("80. Romania      Leu         (RON)" )
                        print("81. Russia       Ruble       (RUB)" )
                        print("82. Saint Helena Pound       (SHP)" )
                        print("83. Saudi Arabia Riyal       (SAR)" )
                        print("84. Serbia       Dinar       (RSD)" )
                        print("85. Seychelles   Rupee       (SCR)" )
                        print("86. Singapore    Dollar      (SGD)" )
                        print("87. Solomon I.   Dollar      (SBD)" )
                        print("88. Somalia      Shilling    (SOS)" )
                        print("89. South Africa Rand        (ZAR)" )
                        print("90. Sri Lanka    Rupee       (LKR)" )
                        print("91. Sweden       Krona       (SEK)" )
                        print("92. Switzerland  Franc       (CHF)" )
                        print("93. Suriname     Dollar      (SRD)" )
                        print("94. Syria        Pound       (SYP)" )
                        print("95. Taiwan New   Dollar      (TWD)" )
                        print("96. Thailand     Baht        (THB)" )
                        print("97. T&Tobago     Dollar      (TTD)" )
                        print("98. Turkey       Lira        (TRY)" )
                        print("99. Ukraine      Hryvnia     (UAH)" )
                        print("100.United K.    Pound       (GBP)" )
                        print("101.United S.    Dollar      (USD)" )
                        print("102.Uruguay      Peso        (UYU)" )
                        print("103.Uzbekistan   Som         (UZS)" )
                        print("104.Venezuela    Bolívar     (VEF)" )
                        print("105.Vietnam      Nam Dong    (VND)" )
                        print("106.Yemen        Rial        (YER)" )
                        print("107.Zimbabwe     Dollar      (ZWD)" )

                        #Dictionary from fixer.io
                        #Base Currency EUR
                        #Date : 2020-05-24
                        #API = 9ae5fb7ffd6b4fd06edced48582cc1d8
                        dict_money = {
                            "AED":4.005461,
                            "AFN":83.645689,
                            "ALL":123.799037,
                        ...
                        def Converter(currency_input,currency_output,jumlah_uang):
                            if currency_input != "EUR":
                                jumlah_uang = jumlah_uang / dict_money[currency_input]
                                jumlah_uang * dict_money[currency_output]
                                return jumlah_uang
                            elif currency_input == 'EUR':
                                return jumlah_uang
                            

                        value_input = input("Masukkan jenis Kurs awal yang akan dikonversi (3 huruf kapital): ")
                        value_input = value_input.upper()
                        if value_input in dict_money:
                            value_output = input("Masukkan jenis Kurs akhir (3 huruf kapital): ")
                            value_output = value_output.upper()
                            if value_output in dict_money:
                                try:
                                    value_money = float(input("Masukkan jumlah uang (dalam kurs awal) yang akan diubah ke dalam kurs akhir: "))
                                    if value_money >= 0:        
                                      print(f"Konversi Mata Uang dari {value_input} ke {value_output} adalah: {Converter(value_input,value_output,value_money)}")
                                    else:
                                      print("Jumlah uang yang anda masukkan salah!")
                                except:
                                    print("Jumlah uang yang anda masukkan salah!")   
                            else:
                                print("Jenis Kurs yang anda masukkan tidak tersedia!")       
                        else:
                            print("Jenis Kurs yang anda masukkan tidak tersedia!")
                        print("\n")
                    ### GANTI PASSWORD
